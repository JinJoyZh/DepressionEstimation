...
from models.convlstm import ConvLSTM_Visual, ConvLSTM_Audio, ConvLSTM_Text
...
def get_models(model_config, args, model_type=None, ckpt_path=None):
    ...
    # fusion_net = Bottleneck(inplanes=model_config['FUSION_NET']['INPUT_DIM'], 
    ...
    weights_path = os.path.join(os.path.abspath(os.path.dirname(__file__)), "weights/depressionestimation/AVT+ConvBiLSTM+PHQ-Subscores+Sub-Attention.pt")
